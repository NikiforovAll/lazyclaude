...
|-----------|---------------|--------|
| I. Keyboard-First Ergonomics | Does every feature have keyboard shortcuts? Are vim-like keys supported? | [ ] Pass |
| II. Lazygit-Inspired Panel Layout | Does the layout use multi-panel structure with clear focus indicators? | [ ] Pass |
...
- [ ] Active panel clearly indicated
- [ ] Status bar shows mode and keybinding hints
- [ ] Keybinding table in constitution followed
